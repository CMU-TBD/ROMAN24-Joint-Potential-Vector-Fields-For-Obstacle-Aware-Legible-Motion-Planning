...
ax.add_patch(plt.Circle((25, 25), r, color='k'))
ax.add_patch(plt.Circle((33, 40), r, color='b'))

ax.annotate("Obstacle", xy=(25, 25), fontsize=10,color='w', ha="center")
ax.annotate("Goal", xy=(33, 40), fontsize=15,color='w', ha="center")

ax.set_title('Path taken by the Robot ')
plt.savefig('traditional_pf')
